...
import 'package:vsdk_example/settings_main/video/video_widget.dart';
        ...
        Visibility(
          ...
          child: Row(
            ...
            children: [
              ...
              ObxValue<RxBool>((d) {
                return Visibility(
                  visible: d.value == true,
                  child: InkWell(
                    onTap: () {
                      controller.setCameraFrontOrBack();
                    },
                    child: Container(
                      width: 50,
                      height: 80,
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 5),
                          ObxValue<RxBool>((data) {
                            return Text(data.value ? "前置" : "后置");
                          }, state.isPhoneCameraFront)
                        ],
                      ),
                    ),
                  ),

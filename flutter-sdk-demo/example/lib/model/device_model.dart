...
class DeviceModel {
  ...
  var isSupportVideoCall = RxBool(false);
  var videoCallConnectState = 0.obs;

  ///带屏设备相关参数
  var videoCallScreenSleepTime = 60.obs;
  var videoCallScreenSleepFlag = 0.obs;
  var videoCallScreenBrightness = 50.obs;
  var videoCallScreenMode = 0.obs;
